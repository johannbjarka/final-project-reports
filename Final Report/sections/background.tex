...
\subsection{CCP Games and EVE Online}
	...
	In order to entice EVE players to play our \emph{game with a purpose}, we offer EVE Online currency for each task solved, that way we are offering the players something that is already of value to them.

	%Insert "The goal of this project is creating such a game within EVE Online, a huge game with a huge player base. We reward players with EVE currency, stimulates players to do more work, by using currency that are valuable to players is something other games were unable to do"
