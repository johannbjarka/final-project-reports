...
% Move (GWAP) \cite{GWAP}. That is, the abbreviation and the citation.
...
% If you state sentences like that you must back it up, do you have any numbers to back this up?
spend each year on video games is in the billions. If we could channel some of that time and energy into 
% Here you are stating that games are not useful, I beg to disagree.
...
% Try to be more general here you are saying the "project" without stating which project. If you are stating this is in general, be more general, otherwise discuss the research and then you can use "the project"
...
% Is that a fact? Do you have something to back up this fact? Have they tried any particular algorithms?
...
% I would move this to the project plan section.
