\section{Project Discovery}\label{sec:projectdiscovery}
	In this section we discuss the Project Discovery game in detail and explain how its played. We consider how it communicates with MMOS' API, we outline the code architecture of the game client and how it fits into the EVE Online client. Finally, we go over the website we built to go along with the game's launch.
