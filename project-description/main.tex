...
%Before you go through the work already done, please give the reader a description of the project.
...
% You don't need to tell me the status here where you have a section below with the title "Current status of the project".
% This section should focused telling the reader about MMOS and Citizen Science.
